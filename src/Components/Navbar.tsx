...
export default function Navbar() {
  ...
  return (
    <nav className="p-3 rounded-xl bg-emerald-800 border-emerald-700 px-10 sm:px-4 py-2.5 mb-10">
      <div id="principal" className="container flex  mx-5 items-center justify-between">
        ...
        >
          <ul id="mobile-menu-2"  className="flex flex-col p-4 mt-4 rounded-lg my-auto md:flex-row md:space-x-8 md:mt-0 max-md:hidden">
            <li>
          ...
          <ul>
            <li>
              <div className="flex items-center mr-5 md:order-2 max-md:ml-auto">
                <button
                  type="button"
                  className="flex text-sm bg-emerald-800 rounded-full md:mr-0 p-0"
                  id="user-menu-button"
                  aria-expanded="false"
              ...
              <span className="block text-sm text-white">
                ...
                >
                  ...
                  <Hamburger direction="right" toggled={isToggled} />
                </button>
              </div>
            </li>
          </ul>
