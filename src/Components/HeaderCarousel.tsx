...
export default function HeaderCarousel(props: CarouselProps) {
  return (
    <div className="mt-4 bg-emerald-800 w-full left-0">
      <div className="relative" data-carousel="slide">
        <div className="overflow-hidden relative h-56 sm:h-64 md:h-80 xl:h-96">
        ...
        <div className="flex absolute left-0 top-0 justify-center items-center h-56 sm:h-64 md:h-80 xl:h-96 z-20 right-0 text-white bg-black bg-opacity-50">
          <h1>{props.title}</h1>
        </div>
